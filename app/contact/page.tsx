      ...
      <div className="bg-navy-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-200 max-w-2xl">
            Get in touch with Tech Level Engineering for commercial kitchen equipment, services, and support.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-dark mb-6">
                Have questions about our products or services? Need a quote or technical support? We're here to help.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-navy-primary mb-1">Phone / WhatsApp</h3>
                  <a
                    href="tel:03214057902"
                    className="text-gray-dark hover:text-orange-accent transition-colors"
                  >
                    03214057902
                  </a>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-navy-primary mb-1">Email</h3>
                  <a
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-navy-primary mb-1">WhatsApp</h3>
                  <a
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="font-semibold text-navy-primary mb-4">Quick Links</h3>
              <div className="space-y-3">
                <Link href="/products" className="block text-gray-dark hover:text-orange-accent transition-colors">
                  Browse Products
                </Link>
                <Link href="/services" className="block text-gray-dark hover:text-orange-accent transition-colors">
                  Our Services
                </Link>
                <Link href="/repair-maintenance" className="block text-gray-dark hover:text-orange-accent transition-colors">
                  Request Repair
                </Link>
              </div>
            </div>
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full px-6 py-3 bg-orange-accent text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
